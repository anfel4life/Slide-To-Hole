package com.broodproduct.slide.test;
...
public class BoxApp extends ApplicationAdapter {
	...
	private void createBottle() {
		...
		BodyEditorLoader loader = new BodyEditorLoader(Gdx.files.internal("example-data/test.json"));
	...
	private void createSprites() {
		bottleTexture = new Texture(Gdx.files.internal("example-data/gfx/bottle.png"));
		...
		ballTexture = new Texture(Gdx.files.internal("example-data/gfx/ball.png"));
		...
		whiteTexture = new Texture(Gdx.files.internal("example-data/gfx/white.png"));
